...
from megakernels.demos.qwen3b.instructions import (
    DownProjResidual,
    Globals,
    Instruction,
...
def schedule_downproj(globs: Globals, layer_idx: int):
    ...
    num_down_blocks = assert_div(globs.hidden_size, globs.down_proj_block_size)  # 128
    num_col_splits = globs.intermediate_size // globs.hidden_size + 1  # 5 + 1 label
    sm_count = globs.sm_count()
...
class Qwen3BScheduleBuilder(ScheduleBuilder):
    @classmethod
