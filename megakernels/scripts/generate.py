...
class ScriptConfig(pydra.Config):
    ...
    def l1(self):
        self.model = "/home/ziming/.cache/modelscope/hub/models/LLM-Research/Llama-3___2-1B-Instruct"
...
def main(config: ScriptConfig):
    ...
    if config.tokens:
        ...
        print("Output text: ", tokenizer.batch_decode(to_cpu, skip_special_tokens=True))
