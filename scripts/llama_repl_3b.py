...
class ScriptConfig(pydra.Config):
    model: str = (
        "/home/weiqiang/.cache/huggingface/hub/models--meta-llama--Llama-3.2-3B-Instruct/snapshots/0cb88a4f764b7a12671c53f0838cd831a0843b95"
    )
    device: str = "cuda:0"
    max_tokens_per_turn: int = 1024

    mk_dir: Path = Path(__file__).parent.parent.parent / "demos" / "llama3b_v1"
    mode: str = "mk"
    # mode: str = "pyvm"
    # mode: str = "torch"
    sched: str = "rr"
    setting: str = "llama3b_v1"
